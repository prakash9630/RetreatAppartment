...
public class Restaurant_activity extends Fragment {
    ...
    public List<RecyclerInformation> getRestorents()
    {
        ...
        int[] icon={R.drawable.gaia_restaurant,R.drawable.le_sherpa,R.drawable.roadhouse_cafe,R.drawable.fire,R.drawable.gardenofdream,R.drawable.amegos};
        String[] name={"GAIA RESTAURANT & COFFEE SHOP","LE-SHERPA","ROADHOUSE CAFÉ","FIRE AND ICE PIZZERIA","GARDEN OF DREAMS","Amigo's cafe"};
