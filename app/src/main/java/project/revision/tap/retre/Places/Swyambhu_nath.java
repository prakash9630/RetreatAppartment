package project.revision.tap.retre.Places;
...
public class Swyambhu_nath extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Swyambhu_nath.this, "There is no Internet Connection", Toast.LENGTH_SHORT).show();
                }
    ...
    void getDirection() {
        String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?daddr=%f,%f (%s)", 27.715293, 85.290496, "Swayambhunath Temple");
